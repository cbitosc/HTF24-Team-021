const responses = {
    ...
    "help": ["It's great that you're reaching out. Consider speaking to a professional."],
    ...
    "default": ["I'm here to help. Try asking about stress relief, breathing exercises, or relaxation tips.", "You can try a breathing exercise to help you feel more grounded."],
    relief: ["Relief is a free to use chatbot that helps in supporing mental health!"]
};
